...
public class TMapWebService {
    ...
    public void setParameters(String[] parametersName, String[] parameterData, int size) {
        for (int i = 0; i < size; i++) {
            if (i == 0) {
                mStrFullURI += mStrURI + "?" + parametersName[i] + "=" + parameterData[i];
                continue;
            }

            mStrFullURI += "&" + parametersName[i] + "=" + parameterData[i];
        }
    }
