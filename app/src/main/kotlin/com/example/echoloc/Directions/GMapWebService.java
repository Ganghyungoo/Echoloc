...
public class GMapWebService {
    ...
    public GMapWebService(String uri) { this.mStrURI = uri;}
    ...
    public ArrayList<LatLng> connectWebService(String jsonKey) {
        try {
            ...
            ArrayList<LatLng> points = parseJSON(json, jsonKey);
            return points;
    ...
    private ArrayList<LatLng> parseJSON(JSONObject jsonObject, String arrKey) throws JSONException {
